...
<body>
    ...
    ?>
        <nav class="navbar navbar-expand-sm navbar-dark fixed-top" style="background:#ec6f66d8;backdrop-filter:blur(15px)">
          <a class="navbar-brand" href="#">Ayush Taparia</a>
          <div class="collapse navbar-collapse">
           <div class="navbar-nav">
              <a href="https://github.com/AyushTaparia" class="nav-item nav-link">Github</a>
              <a href="https://www.linkedin.com/in/ayush-taparia-1812at/" class="nav-item nav-link">LinkedIn</a>
            </div>
           </div>
        </nav>
